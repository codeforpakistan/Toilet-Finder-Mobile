...
import com.watsoncell.toiletfinder.ReviewToiletActivity
import com.watsoncell.toiletfinder.adapter.UserReviewPagerAdapter
import com.watsoncell.toiletfinder.models.NearByToiletDTO
import com.watsoncell.toiletfinder.models.UserReviewModel
import com.watsoncell.toiletfinder.utils.CalculateToiletRating
...
class ToiletDetailFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun initViews(view: View?) {
        ...
        tvToiletDistance.text = "Distance - ${toiletDetail.distance} km"
        ...
        //user toilet review
        if (toiletDetail.feedback!!.size > 0) {
