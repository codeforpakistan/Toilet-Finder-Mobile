...
import com.watsoncell.publictoiletfinder.adapter.NearbyToiletAdapter
import com.watsoncell.publictoiletfinder.dialog.ExploreFragmentDialog
import com.watsoncell.publictoiletfinder.dialog.NavigateFragmentDialog
import com.watsoncell.publictoiletfinder.dialog.UserRateFragmentDialog
...
class HomeFragment : Fragment(), NearbyToiletAdapter.NearbyToiletInterface {
    ...
    override fun onCreateView(
        ...
        if (InternetConnection.isNetworkAvailable(activity!!)) {
            ...
            Log.d("arsalan","city: ${gpsTracker.getCity()}")
